...
3. Follow the query labels and deduplication guidance in
   `docs/observability.md`; inspect `config.alloy` for the actual series.
4. Validate JSON and inspect changed panels in Grafana after an approved
