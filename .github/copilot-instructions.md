...
- When fixing a bug or adding a pattern, audit for the same class of issue across the codebase. See the [bot-implement skill](.github/skills/bot-implement/SKILL.md) for review response guidelines.
