...
- When fixing a bug or adding a pattern, audit for the same class of issue across the codebase. See the [auto-implement skill](.github/skills/auto-implement/SKILL.md) for review response guidelines.
